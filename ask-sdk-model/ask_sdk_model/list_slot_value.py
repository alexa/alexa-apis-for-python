...
class ListSlotValue(SlotValue):
    ...
    deserialized_types = {
        'object_type': 'str',
        'values': 'list[ask_sdk_model.slot_value.SlotValue]'
    }  # type: Dict
    ...
    def __init__(self, values=None):
        ...
        :type values: (optional) list[ask_sdk_model.slot_value.SlotValue]
        """
        self.__discriminator_value = "List"  # type: str

        self.object_type = self.__discriminator_value
        super(ListSlotValue, self).__init__(object_type=self.__discriminator_value)
        self.values = values
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListSlotValue):
            return False
