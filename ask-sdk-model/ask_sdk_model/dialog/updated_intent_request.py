...
class UpdatedIntentRequest(UpdatedRequest):
    """
    ...
    def __init__(self, intent=None):
        ...
        super(UpdatedIntentRequest, self).__init__(object_type=self.__discriminator_value)
        self.intent = intent
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdatedIntentRequest):
            return False
