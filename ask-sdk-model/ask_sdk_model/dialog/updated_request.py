...
class UpdatedRequest(object):
    ...
    discriminator_value_class_map = {
        'Dialog.InputRequest': 'ask_sdk_model.dialog.updated_input_request.UpdatedInputRequest',
        'IntentRequest': 'ask_sdk_model.dialog.updated_intent_request.UpdatedIntentRequest'
    }
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdatedRequest):
            return False
