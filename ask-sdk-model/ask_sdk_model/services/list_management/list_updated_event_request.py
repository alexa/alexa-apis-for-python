...
class ListUpdatedEventRequest(Request):
    """
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None, body=None):
        # type: (Optional[str], Optional[datetime], Optional[str], Optional[ListBody]) -> None
        """
        ...
        :type body: (optional) ask_sdk_model.services.list_management.list_body.ListBody
        """
        self.__discriminator_value = "AlexaHouseholdListEvent.ListUpdated"

        self.object_type = self.__discriminator_value
        super(ListUpdatedEventRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp, locale=locale)
        self.body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListUpdatedEventRequest):
            return False
