...
class ListCreatedEventRequest(Request):
    """
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None, body=None):
        ...
        :type body: (optional) ask_sdk_model.services.list_management.list_body.ListBody
        """
        self.__discriminator_value = "AlexaHouseholdListEvent.ListCreated"

        self.object_type = self.__discriminator_value
        super(ListCreatedEventRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp, locale=locale)
        self.body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListCreatedEventRequest):
            return False
