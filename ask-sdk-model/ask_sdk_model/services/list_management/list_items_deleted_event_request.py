...
class ListItemsDeletedEventRequest(Request):
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None, body=None):
        # type: (Optional[str], Optional[datetime], Optional[str], Optional[ListItemBody]) -> None
        """
        ...
        super(ListItemsDeletedEventRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp, locale=locale)
        self.body = body
