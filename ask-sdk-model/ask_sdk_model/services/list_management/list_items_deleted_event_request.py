...
class ListItemsDeletedEventRequest(Request):
    """
    ...
    def __init__(self, request_id=None, timestamp=None, body=None, event_creation_time=None, event_publishing_time=None):
        # type: (Optional[str], Optional[datetime], Optional[ListItemBody], Optional[datetime], Optional[datetime]) -> None
        """
        ...
        :type event_publishing_time: (optional) datetime
        """
        self.__discriminator_value = "AlexaHouseholdListEvent.ItemsDeleted"

        self.object_type = self.__discriminator_value
        super(ListItemsDeletedEventRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp)
        self.body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListItemsDeletedEventRequest):
            return False
