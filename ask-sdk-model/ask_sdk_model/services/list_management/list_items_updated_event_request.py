...
class ListItemsUpdatedEventRequest(Request):
    ...
    def __init__(self, request_id=None, timestamp=None, body=None, event_creation_time=None, event_publishing_time=None):
        ...
        :type event_publishing_time: (optional) datetime
        """
        self.__discriminator_value = "AlexaHouseholdListEvent.ItemsUpdated"

        self.object_type = self.__discriminator_value
        super(ListItemsUpdatedEventRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp)
        self.body = body
