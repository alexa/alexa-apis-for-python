...
class CreationBehavior(object):
    ...
    """
    deserialized_types = {
        'display_experience': 'ask_sdk_model.services.timer_management.display_experience.DisplayExperience'
    }  # type: Dict

    attribute_map = {
        'display_experience': 'displayExperience'
    }  # type: Dict
    ...
    def __init__(self, display_experience=None):
        ...
        self.display_experience = display_experience
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreationBehavior):
            return False
