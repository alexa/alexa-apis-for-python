...
class LaunchTaskOperation(Operation):
    ...
    deserialized_types = {
        'object_type': 'str',
        'text_to_confirm': 'list[ask_sdk_model.services.timer_management.text_to_confirm.TextToConfirm]',
        'task': 'ask_sdk_model.services.timer_management.task.Task'
    }  # type: Dict

    attribute_map = {
        'object_type': 'type',
        'text_to_confirm': 'textToConfirm',
        'task': 'task'
    }  # type: Dict
    ...
    def __init__(self, text_to_confirm=None, task=None):
        ...
        :type task: (optional) ask_sdk_model.services.timer_management.task.Task
        """
        self.__discriminator_value = "LAUNCH_TASK"  # type: str

        self.object_type = self.__discriminator_value
        super(LaunchTaskOperation, self).__init__(object_type=self.__discriminator_value)
        self.text_to_confirm = text_to_confirm
        self.task = task
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LaunchTaskOperation):
            return False
