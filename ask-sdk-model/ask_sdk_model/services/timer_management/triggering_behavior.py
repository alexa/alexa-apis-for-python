...
class TriggeringBehavior(object):
    ...
    """
    deserialized_types = {
        'operation': 'ask_sdk_model.services.timer_management.operation.Operation',
        'notification_config': 'ask_sdk_model.services.timer_management.notification_config.NotificationConfig'
    }  # type: Dict
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TriggeringBehavior):
            return False
