...
class ExpiredRequest(Request):
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None, token=None, expiration_payload=None):
        ...
        :type expiration_payload: (optional) object
        """
        self.__discriminator_value = "CustomInterfaceController.Expired"  # type: str

        self.object_type = self.__discriminator_value
        super(ExpiredRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp, locale=locale)
        self.token = token
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExpiredRequest):
            return False
