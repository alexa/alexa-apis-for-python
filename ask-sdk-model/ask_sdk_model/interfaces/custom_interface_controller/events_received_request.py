...
class EventsReceivedRequest(Request):
    ...
    deserialized_types = {
        ...
        'locale': 'str',
        'token': 'str',
        'events': 'list[ask_sdk_model.interfaces.custom_interface_controller.event.Event]'
    }  # type: Dict
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None, token=None, events=None):
        ...
        :type events: (optional) list[ask_sdk_model.interfaces.custom_interface_controller.event.Event]
        """
        self.__discriminator_value = "CustomInterfaceController.EventsReceived"  # type: str

        self.object_type = self.__discriminator_value
        super(EventsReceivedRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp, locale=locale)
        self.token = token
        self.events = events
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EventsReceivedRequest):
            return False
