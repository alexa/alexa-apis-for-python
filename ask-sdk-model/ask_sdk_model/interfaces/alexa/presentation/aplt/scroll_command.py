...
class ScrollCommand(Command):
    ...
    def __init__(self, delay=None, description=None, screen_lock=None, when=None, distance=None, component_id=None):
        # type: (Optional[int], Optional[str], Optional[bool], Union[bool, str, None], Union[int, str, None], Optional[str]) -> None
        """Scroll a ScrollView or Sequence forward or backward by a number of pages. The Scroll command has the following properties in addition to the regular command properties.
        ...
        super(ScrollCommand, self).__init__(object_type=self.__discriminator_value, delay=delay, description=description, screen_lock=screen_lock, when=when)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ScrollCommand):
            return False
