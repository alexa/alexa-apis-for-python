...
if typing.TYPE_CHECKING:
    ...
    from ask_sdk_model.interfaces.alexa.presentation.aplt.position import Position
...
class SetPageCommand(Command):
    ...
    deserialized_types = {
        ...
        'when': 'bool',
        'component_id': 'str',
        'position': 'ask_sdk_model.interfaces.alexa.presentation.aplt.position.Position',
        'value': 'int'
    }  # type: Dict
    ...
    def __init__(self, delay=None, description=None, screen_lock=None, when=None, component_id=None, position=None, value=None):
        # type: (Optional[int], Optional[str], Optional[bool], Union[bool, str, None], Optional[str], Optional[Position], Union[int, str, None]) -> None
        """Change the page displayed in a Pager component. The SetPage command finishes when the item is fully in view.
        ...
        super(SetPageCommand, self).__init__(object_type=self.__discriminator_value, delay=delay, description=description, screen_lock=screen_lock, when=when)
