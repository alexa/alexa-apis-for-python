...
class RuntimeErrorEvent(Request):
    ...
    deserialized_types = {
        ...
        'locale': 'str',
        'token': 'str',
        'errors': 'list[ask_sdk_model.interfaces.alexa.presentation.apl.runtime_error.RuntimeError]'
    }  # type: Dict
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None, token=None, errors=None):
        ...
        :type errors: (optional) list[ask_sdk_model.interfaces.alexa.presentation.apl.runtime_error.RuntimeError]
        """
        self.__discriminator_value = "Alexa.Presentation.APL.RuntimeError"  # type: str

        self.object_type = self.__discriminator_value
        super(RuntimeErrorEvent, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp, locale=locale)
        self.token = token
        self.errors = errors
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RuntimeErrorEvent):
            return False
