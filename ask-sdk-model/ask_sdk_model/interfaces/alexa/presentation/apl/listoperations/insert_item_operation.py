...
class InsertItemOperation(Operation):
    """
    ...
    def __init__(self, index=None, item=None):
        ...
        :type item: (optional) object
        """
        self.__discriminator_value = "InsertItem"  # type: str

        self.object_type = self.__discriminator_value
        super(InsertItemOperation, self).__init__(object_type=self.__discriminator_value, index=index)
        self.item = item
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InsertItemOperation):
            return False
