...
class DeleteMultipleItemsOperation(Operation):
    """
    ...
    def __init__(self, index=None, count=None):
        ...
        :type count: (optional) int
        """
        self.__discriminator_value = "DeleteMultipleItems"  # type: str

        self.object_type = self.__discriminator_value
        super(DeleteMultipleItemsOperation, self).__init__(object_type=self.__discriminator_value, index=index)
        self.count = count
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteMultipleItemsOperation):
            return False
