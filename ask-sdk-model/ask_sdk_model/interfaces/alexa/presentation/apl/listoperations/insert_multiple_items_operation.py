...
class InsertMultipleItemsOperation(Operation):
    """
    ...
    def __init__(self, index=None, items=None):
        # type: (Optional[int], Optional[List[object]]) -> None
        """Inserts an array of items into consecutive indexes in a dynamicIndexList.
        ...
        :type items: (optional) list[object]
        """
        self.__discriminator_value = "InsertMultipleItems"  # type: str

        self.object_type = self.__discriminator_value
        super(InsertMultipleItemsOperation, self).__init__(object_type=self.__discriminator_value, index=index)
        self.items = items
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InsertMultipleItemsOperation):
            return False
