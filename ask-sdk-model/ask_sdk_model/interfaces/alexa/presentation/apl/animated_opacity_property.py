...
class AnimatedOpacityProperty(AnimatedProperty):
    """
    ...
    def __init__(self, object_from=None, to=None):
        ...
        :type to: (optional) float
        """
        self.__discriminator_value = "opacity"  # type: str

        self.object_property = self.__discriminator_value
        super(AnimatedOpacityProperty, self).__init__(object_property=self.__discriminator_value)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AnimatedOpacityProperty):
            return False
