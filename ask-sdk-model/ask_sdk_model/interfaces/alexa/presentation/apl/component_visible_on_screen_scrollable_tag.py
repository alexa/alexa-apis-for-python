...
class ComponentVisibleOnScreenScrollableTag(object):
    ...
    """
    deserialized_types = {
        'direction': 'ask_sdk_model.interfaces.alexa.presentation.apl.component_visible_on_screen_scrollable_tag_direction_enum.ComponentVisibleOnScreenScrollableTagDirectionEnum',
        'allow_forward': 'bool',
        'allow_backward': 'bool'
    }  # type: Dict
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ComponentVisibleOnScreenScrollableTag):
            return False
