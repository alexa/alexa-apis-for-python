...
class RenderDocumentDirective(Directive):
    ...
    def __init__(self, token=None, document=None, datasources=None):
        # type: (Optional[str], Optional[Dict[str, object]], Optional[Dict[str, object]]) -> None
        """
        ...
        :type datasources: (optional) dict(str, object)
        """
        self.__discriminator_value = "Alexa.Presentation.APLA.RenderDocument"  # type: str
