...
class ConnectionsStatus(object):
    """
    Connection Status indicates a high level understanding of the result of ConnectionsRequest.


    :param code: This is a code signifying the status of the request sent by the skill. Protocol adheres to HTTP status codes.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConnectionsStatus):
            return False
