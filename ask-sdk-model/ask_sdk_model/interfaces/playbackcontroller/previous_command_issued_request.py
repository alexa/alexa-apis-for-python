...
class PreviousCommandIssuedRequest(Request):
    """
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None):
        ...
        :type locale: (optional) str
        """
        self.__discriminator_value = "PlaybackController.PreviousCommandIssued"  # type: str
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PreviousCommandIssuedRequest):
            return False
