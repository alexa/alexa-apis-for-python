...
class CompleteTaskDirective(Directive):
    ...
    def __init__(self, status=None, result=None):
        ...
        :type result: (optional) dict(str, object)
        """
        self.__discriminator_value = "Tasks.CompleteTask"  # type: str

        self.object_type = self.__discriminator_value
        super(CompleteTaskDirective, self).__init__(object_type=self.__discriminator_value)
        self.status = status
        self.result = result
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CompleteTaskDirective):
            return False
