...
class ListTemplate2(Template):
    ...
    def __init__(self, token=None, back_button=None, background_image=None, title=None, list_items=None):
        ...
        :type list_items: (optional) list[ask_sdk_model.interfaces.display.list_item.ListItem]
        """
        self.__discriminator_value = "ListTemplate2"  # type: str

        self.object_type = self.__discriminator_value
        super(ListTemplate2, self).__init__(object_type=self.__discriminator_value, token=token, back_button=back_button)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListTemplate2):
            return False
