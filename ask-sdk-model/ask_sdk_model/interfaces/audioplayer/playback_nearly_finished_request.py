...
class PlaybackNearlyFinishedRequest(Request):
    ...
    def __init__(self, request_id=None, timestamp=None, offset_in_milliseconds=None, token=None, locale=None):
        ...
        :type locale: (optional) str
        """
        self.__discriminator_value = "AudioPlayer.PlaybackNearlyFinished"

        self.object_type = self.__discriminator_value
        super(PlaybackNearlyFinishedRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp)
