...
class PlaybackStartedRequest(Request):
    """
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None, offset_in_milliseconds=None, token=None):
        ...
        :type token: (optional) str
        """
        self.__discriminator_value = "AudioPlayer.PlaybackStarted"  # type: str

        self.object_type = self.__discriminator_value
        super(PlaybackStartedRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp, locale=locale)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PlaybackStartedRequest):
            return False
