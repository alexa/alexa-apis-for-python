...
class AuthorizationGrantRequest(Request):
    ...
    :param body: 
    :type body: (optional) ask_sdk_model.authorization.authorization_grant_body.AuthorizationGrantBody
    ...
    deserialized_types = {
        ...
        'timestamp': 'datetime',
        'locale': 'str',
        'body': 'ask_sdk_model.authorization.authorization_grant_body.AuthorizationGrantBody'
    }  # type: Dict
    ...
    def __init__(self, request_id=None, timestamp=None, locale=None, body=None):
        ...
        :type body: (optional) ask_sdk_model.authorization.authorization_grant_body.AuthorizationGrantBody
        """
        self.__discriminator_value = "Alexa.Authorization.Grant"  # type: str

        self.object_type = self.__discriminator_value
        super(AuthorizationGrantRequest, self).__init__(object_type=self.__discriminator_value, request_id=request_id, timestamp=timestamp, locale=locale)
        self.body = body
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AuthorizationGrantRequest):
            return False
