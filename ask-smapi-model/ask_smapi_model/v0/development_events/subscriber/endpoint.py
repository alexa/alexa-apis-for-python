...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v0.development_events.subscriber.endpoint_authorization import EndpointAuthorization as EndpointAuthorization_2de8b344
...
class Endpoint(object):
    ...
    def __init__(self, uri=None, authorization=None):
        # type: (Optional[str], Optional[EndpointAuthorization_2de8b344]) -> None
        """
