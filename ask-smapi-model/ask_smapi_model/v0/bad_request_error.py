...
class BadRequestError(object):
    ...
    :type violations: (optional) list[ask_smapi_model.v0.error.Error]

    """
    deserialized_types = {
        'message': 'str',
        'violations': 'list[ask_smapi_model.v0.error.Error]'
    }  # type: Dict
    ...
    def __init__(self, message=None, violations=None):
        # type: (Optional[str], Optional[List[Error_d660d58]]) -> None
        """
