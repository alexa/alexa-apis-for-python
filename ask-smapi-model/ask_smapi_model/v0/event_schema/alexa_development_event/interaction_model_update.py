...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v0.event_schema.interaction_model_event_attributes import InteractionModelEventAttributesV0
...
class InteractionModelUpdate(BaseSchema):
    ...
    :param payload: 
    :type payload: (optional) ask_smapi_model.v0.event_schema.interaction_model_event_attributes.InteractionModelEventAttributes
    ...
    deserialized_types = {
        ...
        'event_name': 'str',
        'request_id': 'str',
        'payload': 'ask_smapi_model.v0.event_schema.interaction_model_event_attributes.InteractionModelEventAttributes'
    }  # type: Dict
    ...
    def __init__(self, timestamp=None, request_id=None, payload=None):
        # type: (Optional[datetime], Optional[str], Optional[InteractionModelEventAttributesV0]) -> None
        """&#39;AlexaDevelopmentEvent.InteractionModelUpdate&#39; event represents the status of set/update interaction model request. The update request may complete either with &#x60;SUCCEEDED&#x60; or &#x60;FAILED&#x60; status. 
        ...
        :type payload: (optional) ask_smapi_model.v0.event_schema.interaction_model_event_attributes.InteractionModelEventAttributes
        """
        self.__discriminator_value = "AlexaDevelopmentEvent.InteractionModelUpdate"  # type: str

        self.event_name = self.__discriminator_value
        super(InteractionModelUpdate, self).__init__(timestamp=timestamp, event_name=self.__discriminator_value)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InteractionModelUpdate):
            return False
