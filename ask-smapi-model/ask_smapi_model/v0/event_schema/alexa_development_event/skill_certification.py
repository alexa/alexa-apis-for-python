...
class SkillCertification(BaseSchema):
    ...
    def __init__(self, timestamp=None, request_id=None, payload=None):
        ...
        :type payload: (optional) ask_smapi_model.v0.event_schema.skill_event_attributes.SkillEventAttributes
        """
        self.__discriminator_value = "AlexaDevelopmentEvent.SkillCertification"  # type: str

        self.event_name = self.__discriminator_value
        super(SkillCertification, self).__init__(timestamp=timestamp, event_name=self.__discriminator_value)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SkillCertification):
            return False
