...
class ContentUploadFileSummary(object):
    ...
    :type presigned_download_url: (optional) str
    :param status: 
    :type status: (optional) ask_smapi_model.v0.catalog.upload.file_upload_status.FileUploadStatus

    """
    deserialized_types = {
        'presigned_download_url': 'str',
        'status': 'ask_smapi_model.v0.catalog.upload.file_upload_status.FileUploadStatus'
    }  # type: Dict
    ...
    def __init__(self, presigned_download_url=None, status=None):
        # type: (Optional[str], Optional[FileUploadStatus_b7cb5662]) -> None
        """
        ...
        self.presigned_download_url = presigned_download_url
        self.status = status
