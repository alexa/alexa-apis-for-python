...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v1.skill.build_details import BuildDetails
    from ask_smapi_model.v1.skill.status import Status
...
class LastUpdateRequest(object):
    ...
    def __init__(self, status=None, errors=None, warnings=None, build_details=None):
        # type: (Optional[Status], Optional[List[StandardizedError]], Optional[List[StandardizedError]], Optional[BuildDetails]) -> None
        """Contains attributes related to last modification (create/update) request of a resource.
