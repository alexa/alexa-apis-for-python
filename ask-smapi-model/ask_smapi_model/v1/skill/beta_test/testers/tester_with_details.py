...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v1.skill.beta_test.testers.invitation_status import InvitationStatus as Testers_InvitationStatusV1
...
class TesterWithDetails(object):
    ...
    def __init__(self, email_id=None, association_date=None, is_reminder_allowed=None, invitation_status=None):
        # type: (Optional[str], Optional[datetime], Optional[bool], Optional[Testers_InvitationStatusV1]) -> None
        """Tester information.
