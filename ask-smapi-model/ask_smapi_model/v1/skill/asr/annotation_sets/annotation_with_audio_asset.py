...
from ask_smapi_model.v1.skill.asr.annotation_sets.annotation import Annotation


if typing.TYPE_CHECKING:
    from typing import Dict, List, Optional, Union, Any
    from datetime import datetime
    from ask_smapi_model.v1.skill.asr.annotation_sets.audio_asset import AudioAsset as AudioAsset_24d67d02
...
class AnnotationWithAudioAsset(Annotation):
    ...
    deserialized_types = {
        ...
        'audio_asset': 'ask_smapi_model.v1.skill.asr.annotation_sets.audio_asset.AudioAsset'
    }  # type: Dict
    ...
    def __init__(self, upload_id=None, file_path_in_upload=None, evaluation_weight=None, expected_transcription=None, audio_asset=None):
        # type: (Optional[str], Optional[str], Optional[float], Optional[str], Optional[AudioAsset_24d67d02]) -> None
        """Object containing annotation content and audio file download information.
