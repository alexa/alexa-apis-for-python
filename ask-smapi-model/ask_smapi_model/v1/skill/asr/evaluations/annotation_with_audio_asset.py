...
from ask_smapi_model.v1.skill.asr.evaluations.annotation import Annotation


if typing.TYPE_CHECKING:
    from typing import Dict, List, Optional, Union, Any
    from datetime import datetime
    from ask_smapi_model.v1.skill.asr.evaluations.audio_asset import AudioAsset as AudioAsset_5ba858ec
...
class AnnotationWithAudioAsset(Annotation):
    ...
    :param audio_asset: 
    :type audio_asset: (optional) ask_smapi_model.v1.skill.asr.evaluations.audio_asset.AudioAsset
    ...
    deserialized_types = {
        ...
        'audio_asset': 'ask_smapi_model.v1.skill.asr.evaluations.audio_asset.AudioAsset'
    }  # type: Dict
    ...
    def __init__(self, upload_id=None, file_path_in_upload=None, evaluation_weight=None, expected_transcription=None, audio_asset=None):
        # type: (Optional[str], Optional[str], Optional[float], Optional[str], Optional[AudioAsset_5ba858ec]) -> None
        """object containing annotation content and audio file download information.
        ...
        super(AnnotationWithAudioAsset, self).__init__(upload_id=upload_id, file_path_in_upload=file_path_in_upload, evaluation_weight=evaluation_weight, expected_transcription=expected_transcription)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AnnotationWithAudioAsset):
            return False
