...
class ResourceObject(object):
    ...
    .. note::
        ...
        |
        | SlotTypeReference: :py:class:`ask_smapi_model.v1.skill.interaction_model.jobs.slot_type_reference.SlotTypeReference`
    ...
    discriminator_value_class_map = {
        'InteractionModel': 'ask_smapi_model.v1.skill.interaction_model.jobs.interaction_model.InteractionModel',
        'Catalog': 'ask_smapi_model.v1.skill.interaction_model.jobs.catalog.Catalog',
        'SlotTypeReference': 'ask_smapi_model.v1.skill.interaction_model.jobs.slot_type_reference.SlotTypeReference'
    }
