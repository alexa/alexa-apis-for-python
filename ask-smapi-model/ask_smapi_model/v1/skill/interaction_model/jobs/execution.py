...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v1.skill.interaction_model.jobs.job_error_details import JobErrorDetailsV1
...
class Execution(object):
    ...
    def __init__(self, execution_id=None, timestamp=None, error_code=None, status=None, error_details=None):
        # type: (Optional[str], Optional[datetime], Optional[str], Optional[str], Optional[JobErrorDetailsV1]) -> None
        """Execution data.
