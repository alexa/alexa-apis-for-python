...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v1.skill.interaction_model.jobs.execution import Execution as Execution_6b1925c2
...
class GetExecutionsResponse(object):
    ...
    :param executions: 
    :type executions: (optional) list[ask_smapi_model.v1.skill.interaction_model.jobs.execution.Execution]
    ...
    deserialized_types = {
        ...
        'executions': 'list[ask_smapi_model.v1.skill.interaction_model.jobs.execution.Execution]'
    }  # type: Dict
    ...
    def __init__(self, pagination_context=None, links=None, executions=None):
        # type: (Optional[JobAPIPaginationContext_8ba512fb], Optional[Links_bc43467b], Optional[List[Execution_6b1925c2]]) -> None
        """The response of get execution history.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetExecutionsResponse):
            return False
