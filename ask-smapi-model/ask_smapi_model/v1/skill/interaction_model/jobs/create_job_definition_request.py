...
class CreateJobDefinitionRequest(object):
    ...
    :type job_definition: (optional) ask_smapi_model.v1.skill.interaction_model.jobs.job_definition.JobDefinition

    """
    deserialized_types = {
        'vendor_id': 'str',
        'job_definition': 'ask_smapi_model.v1.skill.interaction_model.jobs.job_definition.JobDefinition'
    }  # type: Dict
    ...
    def __init__(self, vendor_id=None, job_definition=None):
        # type: (Optional[str], Optional[JobDefinition_ee5db797]) -> None
        """Request to create job definitions.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateJobDefinitionRequest):
            return False
