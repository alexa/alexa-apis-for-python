...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v1.skill.interaction_model.type_version.slot_type_version_item import SlotTypeVersionItem
...
class ListSlotTypeVersionResponse(object):
    ...
    def __init__(self, links=None, slot_type_versions=None, next_token=None):
        # type: (Optional[Links], Optional[List[SlotTypeVersionItem]], Optional[str]) -> None
        """List of slot type versions of a skill for the vendor.
