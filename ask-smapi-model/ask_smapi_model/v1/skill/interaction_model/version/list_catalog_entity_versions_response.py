...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v1.skill.interaction_model.version.catalog_entity_version import CatalogEntityVersionV1
...
class ListCatalogEntityVersionsResponse(object):
    ...
    :param catalog_versions: List of catalog entity versions. 
    :type catalog_versions: (optional) list[ask_smapi_model.v1.skill.interaction_model.version.catalog_entity_version.CatalogEntityVersion]
    :param is_truncated: 
    ...
    deserialized_types = {
        ...
        'catalog_versions': 'list[ask_smapi_model.v1.skill.interaction_model.version.catalog_entity_version.CatalogEntityVersion]',
        'is_truncated': 'bool',
        'next_token': 'str',
        'total_count': 'int'
    }  # type: Dict
    ...
    def __init__(self, links=None, catalog_versions=None, is_truncated=None, next_token=None, total_count=None):
        # type: (Optional[LinksV1], Optional[List[CatalogEntityVersionV1]], Optional[bool], Optional[str], Optional[int]) -> None
        """List of catalog versions of a catalog for the vendor in sortDirection order, descending as default.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListCatalogEntityVersionsResponse):
            return False
