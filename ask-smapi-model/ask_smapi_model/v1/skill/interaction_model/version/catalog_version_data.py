...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v1.skill.interaction_model.version.input_source import InputSource as InputSource_f7163db5
...
class CatalogVersionData(object):
    ...
    def __init__(self, source=None, description=None, version=None):
        # type: (Optional[InputSource_f7163db5], Optional[str], Optional[str]) -> None
        """Catalog version data with metadata.
