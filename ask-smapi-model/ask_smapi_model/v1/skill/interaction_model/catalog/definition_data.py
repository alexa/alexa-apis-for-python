...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v1.skill.interaction_model.catalog.catalog_input import CatalogInputV1
...
class DefinitionData(object):
    ...
    """
    deserialized_types = {
        'catalog': 'ask_smapi_model.v1.skill.interaction_model.catalog.catalog_input.CatalogInput',
        'vendor_id': 'str'
    }  # type: Dict
    ...
    def __init__(self, catalog=None, vendor_id=None):
        # type: (Optional[CatalogInputV1], Optional[str]) -> None
        """Catalog request definitions.
