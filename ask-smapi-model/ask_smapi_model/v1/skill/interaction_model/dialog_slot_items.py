...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v1.skill.interaction_model.dialog_prompts import DialogPrompts as DialogPrompts_613880e9
    from ask_smapi_model.v1.skill.interaction_model.slot_validation import SlotValidation as SlotValidation_a707da03
...
class DialogSlotItems(object):
    ...
    def __init__(self, name=None, object_type=None, elicitation_required=None, confirmation_required=None, prompts=None, validations=None):
        # type: (Optional[str], Optional[str], Optional[bool], Optional[bool], Optional[DialogPrompts_613880e9], Optional[List[SlotValidation_a707da03]]) -> None
        """
