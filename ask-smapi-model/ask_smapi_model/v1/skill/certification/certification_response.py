...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v1.skill.certification.certification_status import CertificationStatus
    from ask_smapi_model.v1.skill.certification.review_tracking_info import ReviewTrackingInfo
...
class CertificationResponse(object):
    ...
    :type review_tracking_info: (optional) ask_smapi_model.v1.skill.certification.review_tracking_info.ReviewTrackingInfo
    :param result: 
    :type result: (optional) ask_smapi_model.v1.skill.certification.certification_result.CertificationResult
    ...
    deserialized_types = {
        ...
        'review_tracking_info': 'ask_smapi_model.v1.skill.certification.review_tracking_info.ReviewTrackingInfo',
        'result': 'ask_smapi_model.v1.skill.certification.certification_result.CertificationResult'
    }  # type: Dict
    ...
    def __init__(self, id=None, status=None, skill_submission_timestamp=None, review_tracking_info=None, result=None):
        # type: (Optional[str], Optional[CertificationStatus], Optional[datetime], Optional[ReviewTrackingInfo], Optional[CertificationResult]) -> None
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CertificationResponse):
            return False
