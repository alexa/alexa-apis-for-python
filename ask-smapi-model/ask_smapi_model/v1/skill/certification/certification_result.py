...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v1.skill.certification.distribution_info import DistributionInfo as DistributionInfo_e586ad31
...
class CertificationResult(object):
    ...
    :type distribution_info: (optional) ask_smapi_model.v1.skill.certification.distribution_info.DistributionInfo
    ...
    def __init__(self, distribution_info=None):
        # type: (Optional[DistributionInfo_e586ad31]) -> None
        """Structure for the result for the outcomes of certification review for the skill. Currently provides the distribution information of a skill if the certification SUCCEEDED. 
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CertificationResult):
            return False
