...
class ReviewTrackingInfoSummary(object):
    """
    ...
    :param actual_completion_timestamp: Timestamp for actual completion of certification review workflow for the skill.
    ...
    def __init__(self, estimated_completion_timestamp=None, actual_completion_timestamp=None, last_updated=None):
        # type: (Optional[datetime], Optional[datetime], Optional[datetime]) -> None
        """Structure for summarised view of review tracking information of the skill. This does not have the estimationUpdates array field.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReviewTrackingInfoSummary):
            return False
