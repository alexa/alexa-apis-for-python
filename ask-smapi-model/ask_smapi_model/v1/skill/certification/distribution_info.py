...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v1.skill.certification.publication_failure import PublicationFailure as PublicationFailure_998813af
...
class DistributionInfo(object):
    ...
    def __init__(self, published_countries=None, publication_failures=None):
        # type: (Optional[List[object]], Optional[List[PublicationFailure_998813af]]) -> None
        """The distribution information for skill where Amazon distributed the skill
