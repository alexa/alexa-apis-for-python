...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v1.skill.history.intent_request_locales import IntentRequestLocales
    ...
    from ask_smapi_model.v1.skill.history.dialog_act import DialogAct
    from ask_smapi_model.v1.skill.history.intent import Intent
...
class IntentRequest(object):
    ...
    def __init__(self, dialog_act=None, intent=None, interaction_type=None, locale=None, publication_status=None, stage=None, utterance_text=None):
        # type: (Optional[DialogAct], Optional[Intent], Optional[InteractionType], Optional[IntentRequestLocales], Optional[PublicationStatus], Optional[StageType], Optional[str]) -> None
        """
