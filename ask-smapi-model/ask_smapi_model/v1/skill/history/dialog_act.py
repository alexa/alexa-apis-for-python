...
class DialogAct(object):
    ...
    :param name: 
    :type name: (optional) ask_smapi_model.v1.skill.history.dialog_act_name.DialogActName

    """
    deserialized_types = {
        'name': 'ask_smapi_model.v1.skill.history.dialog_act_name.DialogActName'
    }  # type: Dict
    ...
    def __init__(self, name=None):
        # type: (Optional[DialogActName_df8326d6]) -> None
        """The dialog act used in the interaction.
