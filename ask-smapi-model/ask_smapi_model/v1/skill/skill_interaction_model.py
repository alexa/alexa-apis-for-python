...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v1.skill.skill_interaction_model_status import SkillInteractionModelStatus
...
class SkillInteractionModel(object):
    ...
    def __init__(self, locale=None):
        # type: (Optional[Dict[str, SkillInteractionModelStatus]]) -> None
        """Status for available interaction models, keyed by locale. 
