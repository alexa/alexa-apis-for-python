...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v1.skill.export_response_skill import ExportResponseSkillV1
...
class ExportResponse(object):
    ...
    :param skill: 
    :type skill: (optional) ask_smapi_model.v1.skill.export_response_skill.ExportResponseSkill

    """
    deserialized_types = {
        'status': 'ask_smapi_model.v1.skill.response_status.ResponseStatus',
        'skill': 'ask_smapi_model.v1.skill.export_response_skill.ExportResponseSkill'
    }  # type: Dict
    ...
    def __init__(self, status=None, skill=None):
        # type: (Optional[ResponseStatusV1], Optional[ExportResponseSkillV1]) -> None
        """
