...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v1.skill.nlu.evaluations.resolutions_per_authority_value import ResolutionsPerAuthorityValue as ResolutionsPerAuthorityValue_2a33306b
    from ask_smapi_model.v1.skill.nlu.evaluations.resolutions_per_authority_status import ResolutionsPerAuthorityStatus as ResolutionsPerAuthorityStatus_74ba1d4d
...
class ResolutionsPerAuthority(object):
    ...
    def __init__(self, authority=None, status=None, values=None):
        # type: (Optional[str], Optional[ResolutionsPerAuthorityStatus_74ba1d4d], Optional[List[ResolutionsPerAuthorityValue_2a33306b]]) -> None
        """
