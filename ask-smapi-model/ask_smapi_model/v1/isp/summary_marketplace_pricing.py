...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v1.isp.summary_price_listing import SummaryPriceListing as SummaryPriceListing_dd08d917
...
class SummaryMarketplacePricing(object):
    ...
    def __init__(self, release_date=None, default_price_listing=None):
        # type: (Optional[datetime], Optional[SummaryPriceListing_dd08d917]) -> None
        """Localized in-skill product pricing information.
