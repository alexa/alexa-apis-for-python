...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v2.skill.simulations.slot import SlotV2
...
class Intent(object):
    ...
    :type slots: (optional) dict(str, ask_smapi_model.v2.skill.simulations.slot.Slot)

    """
    deserialized_types = {
        'name': 'str',
        'confirmation_status': 'ask_smapi_model.v2.skill.simulations.confirmation_status_type.ConfirmationStatusType',
        'slots': 'dict(str, ask_smapi_model.v2.skill.simulations.slot.Slot)'
    }  # type: Dict
    ...
    def __init__(self, name=None, confirmation_status=None, slots=None):
        # type: (Optional[str], Optional[ConfirmationStatusTypeV2], Optional[Dict[str, SlotV2]]) -> None
        """
