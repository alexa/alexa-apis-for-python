...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v2.skill.simulations.resolutions_per_authority_value_items import ResolutionsPerAuthorityValueItemsV2
    from ask_smapi_model.v2.skill.simulations.resolutions_per_authority_status import ResolutionsPerAuthorityStatusV2
...
class ResolutionsPerAuthorityItems(object):
    ...
    def __init__(self, authority=None, status=None, values=None):
        # type: (Optional[str], Optional[ResolutionsPerAuthorityStatusV2], Optional[List[ResolutionsPerAuthorityValueItemsV2]]) -> None
        """
