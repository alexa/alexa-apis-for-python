...
if typing.TYPE_CHECKING:
    ...
    from ask_smapi_model.v2.skill.invocations.invocation_response_result import InvocationResponseResultV2
    from ask_smapi_model.v2.skill.invocations.invocation_response_status import InvocationResponseStatusV2
...
class InvocationsApiResponse(object):
    ...
    def __init__(self, status=None, result=None):
        # type: (Optional[InvocationResponseStatusV2], Optional[InvocationResponseResultV2]) -> None
        """
