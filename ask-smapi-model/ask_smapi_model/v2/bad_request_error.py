...
class BadRequestError(object):
    ...
    :type violations: (optional) list[ask_smapi_model.v2.error.Error]

    """
    deserialized_types = {
        'message': 'str',
        'violations': 'list[ask_smapi_model.v2.error.Error]'
    }  # type: Dict
    ...
    def __init__(self, message=None, violations=None):
        # type: (Optional[str], Optional[List[Error_ea6c1a5a]]) -> None
        """
